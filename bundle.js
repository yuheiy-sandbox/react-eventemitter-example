...
var App = (function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function addTodo(value) {
      ...
      var todo = { value: value, id: Date.now() };
      todos.push(todo);
    ...
    value: function componentWillMount() {
      _eventemitter2.default.on('addTodo', this.addTodo.bind(this));
    }
  }, {
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_form2.default, { error: this.state.error }),
        _react2.default.createElement(_list2.default, { items: this.state.todos })
      );
    }
  }]);
...
},{"./eventemitter":161,"./form.jsx":162,"./list.jsx":164,"react":159}],161:[function(require,module,exports){
'use strict';
...
exports.default = new _eventemitter.EventEmitter2();

},{"eventemitter2":2}],162:[function(require,module,exports){
'use strict';
...
var Form = (function (_React$Component) {
  ...
  _createClass(Form, [{
    ...
    value: function handleClick() {
      _eventemitter2.default.emit('addTodo', this.refs.field.value);
    }
  }, {
    ...
    key: 'render',
    value: function render() {
      var style = this.props.error ? { backgroundColor: 'red' } : null;

      return _react2.default.createElement(
        'p',
        null,
        _react2.default.createElement('input', { ref: 'field', type: 'text', style: style }),
        ' ',
...
},{"./eventemitter":161,"react":159}],163:[function(require,module,exports){
'use strict';
...
},{"./app.jsx":160,"react":159,"react-dom":3}],164:[function(require,module,exports){
'use strict';
...
},{"./eventemitter":161,"react":159}]},{},[163]);
